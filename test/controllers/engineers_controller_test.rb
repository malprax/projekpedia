...
class EngineersControllerTest < ActionController::TestCase
  ...
  test "should create engineer" do
    assert_difference('Engineer.count') do
      post :create, engineer: { functionality: @engineer.functionality, last_graduate: @engineer.last_graduate, name: @engineer.name, skill: @engineer.skill }
    end
  ...
  test "should update engineer" do
    patch :update, id: @engineer, engineer: { functionality: @engineer.functionality, last_graduate: @engineer.last_graduate, name: @engineer.name, skill: @engineer.skill }
    assert_redirected_to engineer_path(assigns(:engineer))
  end
